...
//블루프린트 노드에서 자동으로 리스너 등록해서 속성값 변경시 호출하게
...
public:
	...
	//static은 아무때나 호출 가능, 이 함수에서 UAsyncTaskAttributeChanged를 생성해서 반환함
...
protected:
	...
	FGameplayAttribute AttributeToListenFor; // 값 들어있는 애 한개 

	TArray<FGameplayAttribute> AttributesToListenFor; // 값 들어있는 애 한개 
